...
layout =[              
        ...
        [sg.Button("Série 2",    key=(2.2), size=(8,3)),
        sg.Button("Série 3",    key=(2.3), size=(8,3))],
        [sg.Button("Série 4",    key=(2.4), size=(8,3)),
        sg.Button("Série 5",    key=(2.5), size=(8,3))]]
window = sg.Window('calculos de resistores',size=(700,500)).layout(layout)
window2_active  = False
window3_active  = False
window4_active  = False
window5_active  = False
window22_active = False
window23_active = False
window24_active = False
window25_active = False
while True:
        ...
        if event == (1.2):
                ...
                layout2 = [
                        ...
                        [sg.Text('A resistencia equivalente é:  '      ),sg.Text(size=(5,1),    key='1.1.1'), sg.Text('Ohms'   )],
                        [sg.Text('Tensão total:                      ' ),sg.Text(size=(5,1),    key='1.1.2'), sg.Text('amperes')],
                        [sg.Text('corrente inteira:                  ' ),sg.Text(size=(5,1),    key='1.1.3'), sg.Text('Watts'  )],
                        [sg.Text('corrente do resistor 1:         '    ),sg.Text(size=(5,1 ),   key='1.2.1'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 2:         '    ),sg.Text(size=(5,1 ),   key='1.2.2'), sg.Text('amperes')],
                        [sg.Text('corrente 1:                         '),sg.Text(size=(5,1),    key='1.3.1'), sg.Text('Watts'  )],
                        [sg.Text('corrente 2:                         '),sg.Text(size=(5,1),    key='1.3.2'), sg.Text('Watts'  )],                        
                        [sg.Button('calcular'                          ),sg.Button('Exit'                                      )]]
                window2 = sg.Window("2 resistores em paralelo", layout2,size=(700,700))        
                while True:
        ...
        if event == (1.3):
                ...
                layout3 = [
                        ...
                        [sg.Text('corrente do resistor 1:       '      ),sg.Text(size=(5,1),     key='1.2.1'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 2:       '      ),sg.Text(size=(5,1),     key='1.2.2'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 3:       '      ),sg.Text(size=(5,1),     key='1.2.3'), sg.Text('amperes')],
                        [sg.Text('corrente 1:                       '  ),sg.Text(size=(5,1),     key='1.3.1'), sg.Text('Watts'  )],
                        [sg.Text('corrente 2:                       '  ),sg.Text(size=(5,1),     key='1.3.2'), sg.Text('Watts'  )],
                        [sg.Text('corrente 3:                       '  ),sg.Text(size=(5,1),     key='1.3.3'), sg.Text('Watts'  )],                        
                        [sg.Button('calcular'                          ),sg.Button('Exit'                                       )]]
                window3 = sg.Window("3 resistores em paralelo", layout3,size=(700,700))        
                while True:
        ...
        if event == (1.4):
                ...
                layout4 = [
                        ...
                        [sg.Text('corrente do resistor 2:       '      ),sg.Text(size=(5,1),     key='1.2.2'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 3:       '      ),sg.Text(size=(5,1),     key='1.2.3'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 4:       '      ),sg.Text(size=(5,1),     key='1.2.4'), sg.Text('amperes')],
                        [sg.Text('corrente 1:                       '  ),sg.Text(size=(5,1),     key='1.3.1'), sg.Text('Watts'  )],
                        [sg.Text('corrente 2:                       '  ),sg.Text(size=(5,1),     key='1.3.2'), sg.Text('Watts'  )],
                        [sg.Text('corrente 3:                       '  ),sg.Text(size=(5,1),     key='1.3.3'), sg.Text('Watts'  )],
                        [sg.Text('corrente 4:                       '  ),sg.Text(size=(5,1),     key='1.3.4'), sg.Text('Watts'  )],                     
                        [sg.Button('calcular'                          ),sg.Button('Exit'                                       )]]
        ...
        if event == (1.5):
                ...
                layout5 = [
                        ...
                        [sg.Text('corrente do resistor 3:       '       ),sg.Text(size=(5,1),    key='1.2.3'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 4:       '       ),sg.Text(size=(5,1),    key='1.2.4'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 5:       '       ),sg.Text(size=(5,1),    key='1.2.5'), sg.Text('amperes')],
                        [sg.Text('corrente 1:                       '   ),sg.Text(size=(5,1),    key='1.3.1'), sg.Text('Watts'  )],
                        [sg.Text('corrente 2:                       '   ),sg.Text(size=(5,1),    key='1.3.2'), sg.Text('Watts'  )],
                        [sg.Text('corrente 3:                       '   ),sg.Text(size=(5,1),    key='1.3.3'), sg.Text('Watts'  )],
                        [sg.Text('corrente 4:                       '   ),sg.Text(size=(5,1),    key='1.3.4'), sg.Text('Watts'  )],
                        [sg.Text('corrente 5:                       '   ),sg.Text(size=(5,1),    key='1.3.5'), sg.Text('Watts'  )],                     
                        [sg.Button('calcular'                           ),sg.Button('Exit'                                      )]]
        ...
        if event == (2.2):
                ...
                layout22 = [
                        ...
                        [sg.Text("Qual é o primeiro resistor?:       " ),sg.Input(              key=1.2                        )],
                        [sg.Text("Qual é o segundo resistor?:       "  ),sg.Input(              key=1.3                        )],
                        [sg.Text('A resistencia equivalente é:  '      ),sg.Text(size=(5,1),    key='2.1.1'), sg.Text('Ohms'   )],
                        [sg.Text('Tensão total:                      ' ),sg.Text(size=(5,1),    key='2.1.2'), sg.Text('amperes')],
                        [sg.Text('corrente inteira:                  ' ),sg.Text(size=(5,1),    key='2.1.3'), sg.Text('Watts'  )],
                        [sg.Text('corrente do resistor 1:         '    ),sg.Text(size=(5,1 ),   key='2.2.1'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 2:         '    ),sg.Text(size=(5,1 ),   key='2.2.2'), sg.Text('amperes')],
                        [sg.Text('corrente 1:                         '),sg.Text(size=(5,1),    key='2.3.1'), sg.Text('Watts'  )],
                        [sg.Text('corrente 2:                         '),sg.Text(size=(5,1),    key='2.3.2'), sg.Text('Watts'  )],                        
                        [sg.Button('calcular'                          ),sg.Button('Exit'                                      )]]
        ...
        if event == (2.3):
                ...
                layout23 = [
                        ...
                        [sg.Text('corrente do resistor 1:       '      ),sg.Text(size=(5,1),     key='2.2.1'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 2:       '      ),sg.Text(size=(5,1),     key='2.2.2'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 3:       '      ),sg.Text(size=(5,1),     key='2.2.3'), sg.Text('amperes')],
                        [sg.Text('corrente 1:                       '  ),sg.Text(size=(5,1),     key='2.3.1'), sg.Text('Watts'  )],
                        [sg.Text('corrente 2:                       '  ),sg.Text(size=(5,1),     key='2.3.2'), sg.Text('Watts'  )],
                        [sg.Text('corrente 3:                       '  ),sg.Text(size=(5,1),     key='2.3.3'), sg.Text('Watts'  )],                        
                        [sg.Button('calcular'                          ),sg.Button('Exit'                                       )]]
        ...
        if event == (2.4):
                ...
                layout24 = [
                        ...
                        [sg.Text('corrente do resistor 2:       '      ),sg.Text(size=(5,1),     key='2.2.2'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 3:       '      ),sg.Text(size=(5,1),     key='2.2.3'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 4:       '      ),sg.Text(size=(5,1),     key='2.2.4'), sg.Text('amperes')],
                        [sg.Text('corrente 1:                       '  ),sg.Text(size=(5,1),     key='2.3.1'), sg.Text('Watts'  )],
                        [sg.Text('corrente 2:                       '  ),sg.Text(size=(5,1),     key='2.3.2'), sg.Text('Watts'  )],
                        [sg.Text('corrente 3:                       '  ),sg.Text(size=(5,1),     key='2.3.3'), sg.Text('Watts'  )],
                        [sg.Text('corrente 4:                       '  ),sg.Text(size=(5,1),     key='2.3.4'), sg.Text('Watts'  )],                     
                        [sg.Button('calcular'                          ),sg.Button('Exit'                                       )]]
        ...
        if event == (2.5):
                ...
                layout25 = [
                        ...
                        [sg.Text('corrente do resistor 3:       '       ),sg.Text(size=(5,1),    key='2.2.3'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 4:       '       ),sg.Text(size=(5,1),    key='2.2.4'), sg.Text('amperes')],
                        [sg.Text('corrente do resistor 5:       '       ),sg.Text(size=(5,1),    key='2.2.5'), sg.Text('amperes')],
                        [sg.Text('corrente 1:                       '   ),sg.Text(size=(5,1),    key='2.3.1'), sg.Text('Watts'  )],
                        [sg.Text('corrente 2:                       '   ),sg.Text(size=(5,1),    key='2.3.2'), sg.Text('Watts'  )],
                        [sg.Text('corrente 3:                       '   ),sg.Text(size=(5,1),    key='2.3.3'), sg.Text('Watts'  )],
                        [sg.Text('corrente 4:                       '   ),sg.Text(size=(5,1),    key='2.3.4'), sg.Text('Watts'  )],
                        [sg.Text('corrente 5:                       '   ),sg.Text(size=(5,1),    key='2.3.5'), sg.Text('Watts'  )],                     
                        [sg.Button('calcular'                           ),sg.Button('Exit'                                      )]]
